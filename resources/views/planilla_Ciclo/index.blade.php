	...
	<div class="box-header with-border">
			<div class="row" >
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					<h3>Listado de Planillas <a href="planilla_ciclo/create"><button class="btn btn-success">Agregar Periodo Ciclo Planilla</button></a> </h3>
							...
							<!--<table class="table table-hover table-striped" cellspacing="0" width="80%">-->
								...
								<tr>
									...
									<td>
										...
										<a href="{{ url('detalleciclo',$proyec->ID) }}"><button class="btn btn-info" >Detalle</button></a>
