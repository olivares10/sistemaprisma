...
@section('main-content')
   ...
   <div class='row'>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="guardar">
            <h3>Ingreso de Personal para Equipo Oficial</h3>
            @if (count($errors)>0)
            ...
            {!!Form::open (array('url'=>'/SPPlanilla_EquipoO','method'=>'POST','autocomplete'=>'off')) !!}
            {{Form::token()}}
    <div class='row'>
    ...
    <div class="row">
        <div class="panel panel-primary">
            <div class="panel-body">
                ...
                <input type="hidden" name="ID_T" id="ID_T"value="1">
                    <div class="form-group">
