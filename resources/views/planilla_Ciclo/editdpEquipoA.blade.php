...
<div class="box box-default">
	<div class="box-header with-border">
			<div class="row" >
                ...
                <h3>Modulo De Planilla por Equipos de trabajo Auxiliar</h3>  
				<a href="{{ url('crearequipoA',$data->ID) }}"><button class="btn btn-info">Crear Equipo</button></a>
				</div>
				...
				<div class="table-responsive" >
							<table class="table table-striped table-condensed table-hover">
								...
								<tr>
									...
									<td>{{$equipo->Equipo}} </td>
									<td>                                    
									<a href="{{ url('editsumproduccionA',$equipo->ID) }}"><button class="btn btn-info" >+</button></a>
                                    </td>															
									<td>	
								...
								<div class="table-responsive" >
									...
									<table class="table table-striped table-bordered table-condensed table-hover">
										...
										<tr>
											...
											<td>{{$proyec->Total}} </td>
											<td>
											<a href="{{ url('editsumplanillaA',$proyec->ID) }}"><button class="btn btn-info" >+</button></a>
