...
@section('main-content')
   ...
   <div class='row'>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="guardar">
            <h3>Ingreso de Personal para Equipo Auxiliar</h3>
            @if (count($errors)>0)
            ...
            {!!Form::open (array('url'=>'/SPPlanilla_EquipoA','method'=>'POST','autocomplete'=>'off')) !!}
            {{Form::token()}}
    <div class='row'>
    ...
    <div class="row">
        <div class="panel panel-primary">
            <div class="panel-body">
                ...
                <input type="hidden" name="ID_Equipo" id="ID_Equipo"value="{{$data2->Equipo+1}}">
                <input type="hidden" name="ID_T" id="ID_T"value="2">
                    <div class="form-group">
                        ...
                        <option value="{{$empleado->ID_EMPLEADO}}_{{$empleado->Cod_Empleado}}_{{$empleado->Nombre_Cargo}}_{{$empleado->dias}}">{{$empleado->Empleado}}</option>
                        @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    ...
                    <input type="text" name="Dias_T" id="Dias_T"  class="form-control" placeholder="Dias Trabajados" >
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div>
