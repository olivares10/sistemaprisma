...
<div class="box box-default">
	<div class="box-header with-border">
			<div class="row" >
                ...
                <h3>Planilla De Personal Administrativo<a href="{{ url('adplanillaPersonal',$data->ID) }}"></h3>  
				<button class="btn btn-success">Agregar Personal</button></a> 
				</div>
			...
			<div class="box-body box-white ">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<!--<table class="table table-hover table-striped" cellspacing="0" width="80%">-->
								...
								<tr>	
									<td>											
									<a href=""data-target="#modal-eliminar-{{$proyec->ID}}" data-toggle="modal"><button class="btn btn-warning" >X</button></a>
									</td>					
                                    ...
                                    <td>{{$proyec->Total}} </td>	            											
									<td>
                                    <a href="{{ url('editsumplanillaAdmin',$proyec->ID) }}"><button class="btn btn-info" >+</button></a>
                                    <a href="{{ url('editplanillaAdmin',$proyec->ID) }}"><button class="btn btn-danger" >-</button></a>		
									</td>
								<tr>
