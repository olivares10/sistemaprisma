	...
	<!-- <div class="box-header with-border"> -->
			<div class="row" >
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<h3>Liquidacion de empleados  <a href="Liquidacion/create"><button class="btn btn-success">Nuevo</button></a></h3>
						...
						<div class="table-responsive" >
							...
							<!--<table class="table table-hover table-striped" cellspacing="0" width="80%">-->
								...
								<tr>
									...
									<td>{{$cat->Causa}} </td>
									<td>
										<a href="{{URL::action('LiquidacionController@edit',$cat->ID)}}"><button class="btn btn-info" >Editar</button></a>
