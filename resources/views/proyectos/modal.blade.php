...
role="dialog" tabindex="-1" id="modal-delete-{{$proyec->ID_PROYECTO}}" style="display:none;">
{{Form::Open(array('action'=>array('ProyectosController@destroy',$proyec->ID_PROYECTO),'method'=>'DELETE'))}}
{{Form::token()}}
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <h4>{{$proyec->ID_PROYECTO}}</h4>
            <h4>{{$proyec->NOMBRE_PROYECTO}}</h4>   
        </div>    
